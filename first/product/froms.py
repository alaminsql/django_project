...
class RecentProduct(forms.Form):
    ...
    laptop= forms.CharField(label='Enter your Laptop name:', min_length=4,max_length=6)
    email=forms.EmailField(initial='alamin88.ime@gmail.com',label_suffix='=',max_length=30)
